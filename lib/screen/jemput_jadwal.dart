...
import '../model/jemput_model.dart';

import 'dart:convert';

import 'package:http/http.dart' as http;

class NungguJadwal extends StatefulWidget {
  const NungguJadwal({super.key});

  @override
  State<NungguJadwal> createState() => _NungguJadwalState();
}

class _NungguJadwalState extends State<NungguJadwal> {
  List<Jemput> listJemput = [];
  RepositoryJemput repository = RepositoryJemput();

  getData() async {
    listJemput = await repository.getnunggu();
    setState(() {});
  }
                              ...
                              onPressed: () async {
                                ...
                                try {
                                  final response = await http.post(
                                    Uri.parse('$url/pesan/selesai/$id'),
                                  );
